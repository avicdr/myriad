...
function Dashboard() {
  ...
  return (
    <div>
      ...
      <div className="row d-flex">
        <div className="col">
          <div className="mx-0 htl_2" >
            <h4 className="bold p-3 card-header-face">Active Users By Post</h4>
        ...
        <div className="col-8">
            <div className="mx-0 htl_2">
              <div className="card-header-face">
              <div className="row d-flex">
                <div className="col-6">
      ...
      <div className="facebookdash row d-flex">
        <div className="col-4">
          <div className="mx-0 htl_2" >
            <h4 className="bold p-3 card-header-face ">Active Users By Post</h4>
            <div className="card-shadow  mx-0 " style={{ height: "400px" }}>
        ...
        <div className="col-8">
          <div className="mx-0 htl_2" >
            <h4 className="bold p-3 card-header-face">Total User Activity</h4>
            <div className="card-shadow  mx-0 " style={{ height: "400px" }}>
      ...
      <div className="facebookdash row d-flex">
        <div className="col">
          ...
          <div className="mx-0 htl_2" >
            <h4 className="bold p-3 card-header-face">Top Languages</h4>
            <div className="card-shadow  mx-0 " style={{ height: "400px" }}>
              <div className="details w-100 overflow-scroll">
                <TopLanguages />
        ...
        <div className="col">
          <div className="mx-0 htl_2" >
            <h4 className="bold p-3 card-header-face">Active Users By Share</h4>
            <div className="card-shadow  mx-0 " style={{ height: "400px" }}>
              <div className="details w-100 overflow-scroll">
        ...
        <div className="col">
          <div className="mx-0 htl_2" >
            <h4 className="bold p-3 card-header-face ">Active Users By Likes</h4>
            <div className="card-shadow  mx-0 " style={{ height: "400px" }}>
              <div className="details w-100 overflow-scroll">
      ...
      <div className="facebookdash row d-flex justify-content-around">
      <div className="col-6" >
            <h4 className="bold p-3 card-header-face">Tweet Sentiments</h4>
            <div className="card-shadow  mx-0 " style={{ height: "400px" }}>
        ...
        <div className="col-6">
          <div className="d-flex flex-column">
          <div className="mx-0 htl_2" >
            <h4 className="bold p-3 card-header-face">World Cloud</h4>
            <div className="card-shadow  mx-0 " style={{ height: "400px" }}>
