...
function LikeStats() {
  return (
    <div>
      <div>
        <div className="cont">
          <h6>Home / Post Smart / Status / Likes</h6>
         ...
         <div className="p-3 d-flex justify-content-end">
          <a href="/instagram/PostSmart/status/likes"><img src={Instagram} className="px-2" /></a>
          <a href="/twitter/tweetsmart/status/likes"><img src={twitter} className="px-2" /></a>
         </div>
        </div>
          ...
          <div className="details w-100">
            <div className="detailItem">
              ...
              <div className="tweetType item w-12-5">Post TYPE</div>
