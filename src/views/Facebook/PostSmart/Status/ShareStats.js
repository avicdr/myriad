...
function Post() {
  return (
    <div>
      <div>
        <div className="cont">
          <h6>Home / Post Smart / Status / Posts</h6>
         ...
         <div className="p-3 d-flex justify-content-end">
          <a href="/instagram/PostSmart/status/share"><img src={Instagram} className="px-2" /></a>
          <a href="/twitter/tweetsmart/status/retweets"><img src={twitter} className="px-2" /></a>
         </div>
        </div>
