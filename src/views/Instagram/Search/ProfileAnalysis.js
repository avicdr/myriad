...
function ProfileAnalysis() {
  return (
    <>
      <div className="cont">
        <h6>Home /Instagram / Search Profile / Analysis</h6>

        <div className="d-flex justify-content-between"> 
        <h2 className="status mb-4 pb-4">Profile Analysis</h2>
         <div className="p-3 d-flex justify-content-end">
          <a href="/facebook/search/analysis"><img src={Facebook} className="px-2" /></a>
        ...
        <div className="d-flex">
          ...
          <div className="w-50">
            ...
            >
              <h3 className="mb-4 mt-2">Analyze Instagram’s profile of</h3>
              <div className="searchHash">
                <Image
