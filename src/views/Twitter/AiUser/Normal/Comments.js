...
import RetweetsBlue from "../../../../components/Static/RetweetBlue.png";
import {
  PopulateGroupSelect,
  PopulateUserSelect,
        ...
        <div className="cont">
          ...
          <div className="d-flex justify-content-between">
            ...
            <div className="p-3 d-flex justify-content-end">
              <a href="/instagram/Aiuser/comments">
                <img src={Instagram} className="px-2" />
              </a>
              <a href="/facebook/Aiuser/comments">
          ...
          <div className="filterBox">
            ...
            <button className="btnColoured commentButton">Comment</button>
          </div>
          <div className="posts">
            <div className="postContainer">
              <div className="post">
                ...
                <hr></hr>
                <div className="comment font-weight-500 fntSz-20">
