...
import { getRetweets } from "../../../../utils/functions";
import HeadNavStats from "./HeadNavStats";
function Retweets() {
  const [totalRetweets, setTotalRetweets] = useState(0);
  useEffect(() => {
    getRetweets("retweets_box", setTotalRetweets, 0, 10);
  }, []);
  ...
  return (
    <div>
      <div>
        <div className="cont">
          <h6>Home / Tweet Smart / Status / Retweets</h6>
          <div
            onClick={() => {
              getRetweets("retweets_box", setTotalRetweets, 0, 10);
            }}
          ...
          <div className="filterBox">
            <div className="mr-4">
              <h2>Tweets</h2>
              <p>Total number of retweets: {totalRetweets}</p>
            </div>
