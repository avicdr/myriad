...
function TweetStats() {
  ...
  return (
    <div>
      <div>
        <div className="cont">
          <h6>Home / Tweet Smart / Status / Tweet</h6>
          <div
            onClick={() => {
              getTweets("tweets_box", setTotalTweets, 0, 10);
            }}
          ...
          <div className="details w-100">
            <div className="detailItem justify-content-between">
              <input type="checkbox" name="checkMe" id="none" />
              <div className="index item">#</div>
              <div className="name item">NAME</div>
              <div className="tweet item w-50">TWEET</div>
              <div className="location item w-min-content">LOCATION</div>
              <div className="tweetType item w-min-content">TWEET TYPE</div>
              <div className="tweetStatus item w-min-content">STATUS</div>
              <div className="timeStamp item w-min-content">TIME STAMP</div>
              <div className="actions d-flex item w-min-content">ACTIONS</div>
            </div>
            <div id="tweets_box">
              <div className="detailItemStats justify-content-between">
                ...
                <div className="location item w-min-content">Mumbai</div>
                <div className="tweetType item w-min-content">Media</div>
                <div className="tweetStatus item w-min-content">Success</div>
                <div className="timeStamp item w-min-content">
                  30/12/2022, 16:34
                </div>
                <div className="actions item w-min-content">
                  <img
